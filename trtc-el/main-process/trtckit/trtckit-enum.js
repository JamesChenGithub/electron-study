const TRTCKitVideoResolutionMode = {
    Landscape   : 0, ///< 横屏分辨率
    Portrait    : 1, ///< 竖屏分辨率
}

const TRTCKitAppScene = {
 ...
 */
const TRTCKitVideoQosPreference = {
    Smooth      : 1, ///< 流畅
    Clear       : 2, ///< 清晰
}

const TRTCKitLogLevel = {
    None        : 0, ///< 不输出任何sdk log
...
const TRTCKitVideoFillMode = {
 ...
 /**
     * 声音播放模式
     */
const TRTCKitAudioRoute = {
    Speakerphone  :   0,   ///< 扬声器
    Earpiece      :   1,   ///< 听筒
}
    
    // only windows/pc use
const  TRTCKitMediaDeviceType = {
    Unknown      :   -1,
...
const  TRTCKitVideoPixelFormat = {
     ...
     * 视频帧源类型
     */
const  TRTCKitVideoFrameSrcType = {
...
const TRTCKitLiveStream = {
    All         : 0,
    Video       : 1,
    Audio       : 2,
}

const TRTCKitAudioQuality = {
    Unknown     : 0,
    VBad        : 1,
    Bad         : 2,
    Poor        : 3,
...
module.exports = {
    ...
    TRTCKitLiveStream : TRTCKitLiveStream,
    TRTCKitAudioQuality : TRTCKitAudioQuality,
}